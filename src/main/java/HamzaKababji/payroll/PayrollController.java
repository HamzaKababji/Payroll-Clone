...
public class PayrollController implements Initializable {
    ...
    public void login() throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(PayrollController.class.getResource("login-View.fxml"));

        // create the root node
        Parent Login = fxmlLoader.load();
        LoginController loginController = (LoginController) fxmlLoader.getController();
        loginController.setPayrollController(this);
        ...
        stage.getIcons().add(new Image("file:src/main/resources/HamzaKababji/payroll/WesternLogo.png"));
        stage.setTitle("Login to PAYROLL");
        stage.initModality(Modality.APPLICATION_MODAL);
        stage.show();
    }
    public void changePassword() throws Exception {
        ...
        // load the fxml file (the UI elements)
        FXMLLoader fxmlLoader = new FXMLLoader(PayrollController.class.getResource("ChangePassword-view.fxml"));
        ...
        changePasswordController.setPayrollController(this);
    ...
    public void createUserAccount() throws Exception {
        // load the fxml file (the UI elements)
        FXMLLoader fxmlLoader = new FXMLLoader(PayrollController.class.getResource("createUserAccount-view.fxml"));
        // create the root node
        ...
        createUserAccountController.setPayrollController(this);
    ...
    public void addNewUserProfile() throws Exception {
        // load the fxml file (the UI elements)
        FXMLLoader fxmlLoader = new FXMLLoader(PayrollController.class.getResource("addNewEmployeeProfile-view.fxml"));
        // create the root node
    ...
    public void modifyEmployeeProfile() throws Exception {
        // load the fxml file (the UI elements)
        FXMLLoader fxmlLoader = new FXMLLoader(PayrollController.class.getResource("modifyEmployeeProfile-view.fxml"));
        // create the root node
        Parent aUser = fxmlLoader.load();
    ...
    public void deleteUserAccount() throws Exception {
        // load the fxml file (the UI elements)
        FXMLLoader fxmlLoader = new FXMLLoader(PayrollController.class.getResource("deleteUserAccount-view.fxml"));
        // create the root node
        Parent aUser = fxmlLoader.load();
        DeleteUserAccountController deleteUserAccountController = (DeleteUserAccountController) fxmlLoader.getController();
        deleteUserAccountController.setPayrollController(this);
    ...
    public void displayAlert(String msg) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(PayrollApplication.class.getResource("alert-View.fxml"));
            // create the root node
