...
public class ChangePasswordController implements Initializable {
    ...
    public void changePassword() {
        ...
        try {
            ...
            String encryptedPassword = payrollController.encrypt(oldPassword.getText());
            ...
            if (encryptedPassword.equals(retrievedEncryptedPassword)) {
                ...
                if (newPassword1.getText().equals(newPassword2.getText())) {
                    ...
                    String encryptedNewPassword = payrollController.encrypt(newPassword1.getText());
                    ...
                    try {
                        ...
                        // Close stage
                        stage.close();
                        payrollController.logout();
                    } catch (SQLException e) {
                        payrollController.displayAlert("Update User Account: " + e.getMessage());
                    }
                } else {
                    // wrong new password
