...
public class CreateUserAccountController implements Initializable {
                ...
                try {
                    ...
                    if (!(userAccount.getUserAccountName() == null)) {
                        ...
                        if (!password1.getText().isEmpty() && (password1.getText().equals(password2.getText()))) {
                            ...
                            String encryptedPassword = payrollController.encrypt(password1.getText());
                            ...
                            try {
                                ...
                                payrollController.displayAlert("Insert User Account: " + ex.getMessage());
                            }
                        } else {
                            // wrong new password
    ...
    private void displayAlert(String msg) {
        try {
            ...
            stage.getIcons().add(new Image("file:src/PAYROLL/WesternLogo.png"));
